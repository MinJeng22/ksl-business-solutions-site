 ...
 * filter: brightness(0) invert(1) renders it white on the dark footer. */
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              {[
                ...
                <span key={s} style={{ display: "block", fontSize: "0.82rem", color: "#7b7fa8", lineHeight: 2.05 }}>
                  {s}
                </span>
              ))}
            </div>
